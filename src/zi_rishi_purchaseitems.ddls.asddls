@AbapCatalog.sqlViewName: 'ZIRISHIPOITEMS'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Purchase Items'
//@VDM.viewType: #BASIC
define view ZI_RISHI_PurchaseItems as select from zpurchase_item
association[1] to ZI_RISHI_PurchaseDetails as _PurchaseHeader on $projection.PurchaseDoc = _PurchaseHeader.PurchaseDoc
